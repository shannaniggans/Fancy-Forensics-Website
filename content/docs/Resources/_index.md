...
|----------------------------------------|-------------|
| [ACSC cyber security challenge](https://www.cyber.gov.au/acsc/view-all-content/news/acsc-cyber-security-challenge) | The ACSC has released a simulated cyber incident challenge so anyone can test or improve their cyber response ability and forensic skills. Organisations may wish to use the challenge as a group training exercise for cyber security staff. The challenge was originally run at the BSides Canberra conference in April 2021. |
| [Metaspike Email Forensics CTF Competition](https://ctf.metaspike.com/) | Email forensics CTF challenges from 2021-2022 are available with solutions. Sign up to be notified when the next CTF challenge is run. |
| [MUS2019 DFIR CTF](https://www.hecfblog.com/2019/04/daily-blog-657-mus2019-dfir-ctf-open-to.html) | The DFIR CTF that was run at the Magnet User Summit in 2019 is now open to the public. |
| [About DFIR Challenge Links](https://aboutdfir.com/education/challenges-ctfs/) | This site provides a much larger and more comprehensive list of DFIR CTF challenges and archives. |
