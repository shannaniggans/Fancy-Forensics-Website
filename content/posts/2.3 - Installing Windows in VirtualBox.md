...
23. Under Preferred languages I'm going to click on English (Australia) then options, and then download the language pack. Once that has been downloaded and installed you can go back to the language screen and choose English (Australia) as your default (and say no sign out later).
	
	![](<../images/Pasted image 20230809190219.png>)

24. While we are here, go to Date & Time from the left menu and select the Time zone of (UTC) Coordinated Universal Time.
	
	![](<../images/Pasted image 20230809190419.png>)

25. Some other useful tweaks to make to your windows system.
* Power settings:
